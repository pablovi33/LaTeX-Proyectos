...
\facultad{Facultad de Ingeniería}                 % Nombre de la facultad/escuela
...
\degree{Ingeniero Eléctrico Electrónico}        % Carrera
\director{Alberto Cortéz Mondragón}               % Director de tesis
...
\include{Capitulo2/metodologia}

%\include{Capitulo2/marco_teorico}           % ~20 páginas - Poner un contexto a la tesis, hacer referencia a trabajos actuales en el tema
\include{Capitulo3/descripcion_equipo}      % ~20 páginas - Explicar el problema en específico que se va a resolver, la metodología y experimentos/métodos utilizados
\include{Capitulo4/resultados_y_analisis}   % ~20 páginas - Presentar los resultados tal cual son, y analizarlos.
\include{Capitulo5/recomendaciones_trabajo_futuro}            % ~5 páginas - Resumir lo que se hizo y lo que no y comentar trabajos futuros sobre el tema
